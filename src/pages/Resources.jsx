  ...
  return (
    <div className="md:mt-20 mt-[65px] flex flex-col items-center">
      ...
      <div className="flex flex-col my-10 items-center justify-center gap-10">
        <div>
          <div className="flex flex-col items-center mb-5 px-12">
            <button
              className="text-3xl md:text-4xl font-semibold text-white border border-white rounded px-4 py-2 hover:bg-white hover:text-black transition duration-300 flex items-center"
