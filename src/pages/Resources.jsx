      ...
      <div className="flex my-10 flex-col md:flex-row  items-center justify-center md:gap-10">
        <div>
          <div className="flex flex-row gap-2 items-center mb-5 px-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-dark-color">
          ...
          <div className="flex flex-col gap-4 px-12 my-2 items-center">
            ...
            <div
              ...
              className="cursor-pointer flex rounded-xl flex-row gap-2 w-[200px] h-[48px] text-primary-color items-center justify-center  font-semibold text-center"
            >
              {/* <svg
        ...
        <div>
          <div className="flex flex-row gap-2 items-center mb-5 px-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-dark-color">
              <span className="text-primary-color">INTERVIEW</span> PREPARATION
            </h1>
          </div>
