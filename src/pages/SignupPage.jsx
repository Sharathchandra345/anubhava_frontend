        ...
        <div className="flex flex-col rounded-lg p-4 w-96 md:w-96 bg-white mx-auto my-auto  gap-4">
          <div className="flex flex-col items-center pt-10 md:pt-20">
            ...
            <h1 className="font-semibold text-base mt-2 text-center text-slate-400">
              Hey, Please enter the relevant details to create your account!
            </h1>
          </div>
          <input
          ...
          <button
            className="p-2 flex flex-col items-center rounded-md bg-primary-new text-white font-semibold"
            type="submit"
            form="formSignup"
          >
            Sign up
          ...
          <div className="p-2 flex flex-col items-center mb-4">
            <h1 className=" mt-5 text-gray-600">
              ...
              <span onClick={handlelogin} className="font-bold cursor-pointer">
                Login in now
              </span>{" "}
            </h1>
              {/* <h1 className=" mt-5 text-gray-600">
                ...
                <span
                  onClick={() =>
                    window.open(
                      " https://chat.whatsapp.com/Je7C9q0yAOXGp74Vq3tskJ",
                      "_blank"
                    )
                  }
