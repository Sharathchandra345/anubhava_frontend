...
export default function JobCard({ title, duration, roles, requirements }) {
  return (
    <div className="bg-white p-4 md:p-10 w-full min-w-[220px] md:w-[740px] min-h-[1000px] flex flex-col md:gap-4 gap-3 items-start justify-start border-2 border-black">
