      ...
      <div className="relative flex items-center md:mx-10 mx-4">
        ...
        >
          {dataArray.map((el, index) => (
            ...
            >
              <div
                className="overflow-hidden w-[200px] h-[200px] gap-2 bg-primary-dark2 text-white
                            bg-off-white flex flex-col justify-center items-center p-2 md:p-4 mx-4 md:mx-8"
                style={{
                  boxShadow:
