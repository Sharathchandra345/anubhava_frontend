      ...
      <div className="fixed top-0 left-0 w-screen h-screen bg-dark-color bg-opacity-80 flex items-center justify-center z-50">
        <div className="p-8">
          ...
          <img
            ...
            src={selectedImage}
            alt="Selected"
            className="cursor-pointer mx-auto w-[512px] h-auto"
          />
          <p
            onClick={() => {
              if (linkedIn) {
            ...
            className={`${
              linkedIn ? "hover:underline cursor-pointer" : ""
            } text-center text-2xl mt-4 text-light-color`}
          >
  ...
  return (
    <div className="flex flex-col mt-10">
      <div className="relative flex items-center md:mx-28 mx-12 mb-5">
        <h1 className="md:text-4xl text-3xl text-off-black font-[500] z-10">
          {text}
        </h1>
      </div>
      ...
      <div className="relative flex items-center md:mx-10 mx-4">
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <div
                className="overflow-hidden md:w-[200px] md:h-[276px] 
                            bg-light-color flex flex-col justify-center items-center p-2 md:p-8 gap-4 mx-4 md:mx-8"
                style={{
